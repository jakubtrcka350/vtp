      ...
      <div className="relative z-10 h-[90px]">
        ...
        <div className="max-w-6xl mx-auto px-6 h-full flex items-center justify-end gap-8">
          ...
          <a
            ...
            className="hidden lg:inline-flex items-center text-white/50 hover:text-white transition-colors duration-200"
      ...
      >
        <nav className="px-6 pb-6 pt-2 flex flex-col gap-1 bg-[#080808]/95 backdrop-blur-sm">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 text-sm text-white/50 hover:text-white transition-colors py-2"
          >
